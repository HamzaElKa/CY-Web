...
<body>
    ...
    <form action="update_profil.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <select id="relationship_status" name="relationship_status">
            <option value="célibataire" <?php echo ($user_data[5] == 'célibataire') ? 'selected' : ''; ?>>Célibataire</option>
            <option value="en couple" <?php echo ($user_data[5] == 'en couple') ? 'selected' : ''; ?>>En couple</option>
            <option value="marié(e)" <?php echo ($user_data[5] == 'marié(e)') ? 'selected' : ''; ?>>Marié(e)</option>
            <option value="divorcé(e)" <?php echo ($user_data[5] == 'divorcé(e)') ? 'selected' : ''; ?>>Divorcé(e)</option>
            <option value="veuf/veuve" <?php echo ($user_data[5] == 'veuf/veuve') ? 'selected' : ''; ?>>Veuf/Veuve</option>
        </select><br>
